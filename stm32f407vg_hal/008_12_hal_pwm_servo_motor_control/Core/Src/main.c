...
period 19999 olması için:
 servo motor 20ms(50Hz) dir.

  period = (timer_tick_frequency / pwm_frequency)-1
  19999 = (timer_tick_frequency/50)-1
  timer_tick_frequency = 1MHz bulunur.
  ...
  duty cycle = istenen / tüm
  mesela : 0.5/20

  20000*(0.5/20) = 500 , 90 degree.
  20000*(1.5/20) = 1500 , 90 degree.
  20000*(2.5/20) = 2500 , 90 degree.
  */
