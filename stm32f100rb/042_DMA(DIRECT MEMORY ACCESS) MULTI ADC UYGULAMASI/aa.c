...
void adc_config(){
	...
	init.ADC_NbrOfChannel=2; // coklu adc okuyacagimiz için kullanilan channel sayisini yazdik 2 channel kullancaz ,channel0 ile channel1
	init.ADC_ScanConvMode=ENABLE; // coklu adc lerde enable ederiz ,tek adc kullacaksak disable ederiz
